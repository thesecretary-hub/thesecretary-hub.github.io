...
import { mountForumNotifications } from './forum-notifications.js?v=1.0.0';
...
const categories = {
  ...
  informal: ['Informal', 'Free, chill hangout and casual conversations.', '#f472b6'],
};
