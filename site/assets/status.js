...
function render(data) {
  ...
  root.innerHTML = `<main class="container page status-page" data-status-content>
    ...
    <section class="status-section reveal"><div class="section-heading"><div><span class="eyebrow">From the team</span><h2>System posts</h2></div><a href="/posts/">View all <b>→</b></a></div><div class="post-grid">${recordCards(data.posts, 'post')}</div></section>
