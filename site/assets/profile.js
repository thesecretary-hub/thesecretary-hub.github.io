...
function render(){
  ...
  form.onsubmit=save;
  root.querySelector('[data-profile-logout]').onclick=async()=>{await supabase.auth.signOut();location.href='/';};
}
